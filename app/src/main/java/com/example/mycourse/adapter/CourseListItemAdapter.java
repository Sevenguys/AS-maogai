...
import com.example.mycourse.activity.VideoListActivity;
import com.example.mycourse.bean.CourseBean;

public class CourseListItemAdapter extends RecyclerView.Adapter<com.example.mycourse.adapter.CourseListItemAdapter.ViewHolder> {
        ...
        if (object != null){
            ...
            switch (object.id){
                ...
                case 10:
                    ...
                    break;
                case 11:
                    holder.ivCourseImg.setImageResource(R.drawable.chapter_11_icon);
                    break;
                case 12:
                    holder.ivCourseImg.setImageResource(R.drawable.chapter_12_icon);
                    break;
                case 13:
                    holder.ivCourseImg.setImageResource(R.drawable.chapter_13_icon);
                    break;
                case 14:
                    holder.ivCourseImg.setImageResource(R.drawable.chapter_14_icon);
                    break;
                case 15:
                    holder.ivCourseImg.setImageResource(R.drawable.chapter_15_icon);
                    break;
            }
