...
import com.example.mycourse.activity.LoginActivity;
import com.example.mycourse.activity.PlayHistoryActivity;
import com.example.mycourse.activity.ReadBookActivity;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.rl_book4:
                ...
                intent.putExtra("st", Integer.toString(v.getId()));
                getActivity().startActivity(intent);
                break;
        }
    }
