...
import com.example.mycourse.adapter.VideoListItemAdapter;
import com.example.mycourse.bean.VideoBean;
...
public class VideoListActivity extends Activity {
    ...
    private void initView() {
        ...
        webViewInfo=(WebView)findViewById(R.id.wb_1);
        ...
        tvCourse.setBackgroundColor(Color.parseColor("#FFFFFF"));
        tvIntro.setTextColor(Color.parseColor("#FFFFFF"));
        tvVideo.setTextColor(Color.parseColor("#000000"));
        tvCourse.setTextColor(Color.parseColor("#000000"));
        ...
        tvCourse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                webViewInfo.setVisibility(View.VISIBLE);

                tvIntro.setBackgroundColor(Color.parseColor("#FFFFFF"));
                tvVideo.setBackgroundColor(Color.parseColor("#FFFFFF"));
                tvCourse.setBackgroundColor(Color.parseColor("#30B4FF"));
